    ...
    if (breakpoint >= Breakpoint.SM || fullWidth) {
        Row(
            modifier = modifier
                ...
                .padding(left = 20.px)
                .height(54.px)
                .backgroundColor(if (darkTheme) Theme.DarkGray.rgb else Theme.LightGray.rgb)
                .borderRadius(r = 100.px)
                .border(
                    width = 2.px,
                    style = LineStyle.Solid,
                    color = if (focused.value && !darkTheme) Theme.Primary.rgb
                    else if (focused.value && darkTheme) Theme.Primary.rgb
                    else if (!focused.value && !darkTheme) Theme.LightGray.rgb
                    else if (!focused.value && darkTheme) Theme.Secondary.rgb
            ...
            FaMagnifyingGlass(
                modifier = Modifier
                    .margin(right = 14.px)
                    .color(if (focused.value) Theme.Primary.rgb else Theme.DarkGray.rgb)
